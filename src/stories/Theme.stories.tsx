...
const ThemePage = () => (
  <div style={{ maxWidth: 860, fontFamily: fontFamily.sans }}>
    ...
    <p style={{ fontSize: 15, color: text.muted, margin: '0 0 36px', lineHeight: '24px' }}>
      Surfaces, elevation, and semantic intent in context. These composites show how Aegis tokens work together to create the visual language of healthcare interfaces.
    </p>
