...
const ColorsPage = () => (
  <PageShell
    title="Color"
    description="The Aegis color system is built for clarity and trust. Brand blue provides the primary identity. Teal supports secondary accents. Neutrals carry the interface. Semantic colors signal status without ambiguity."
  >
...
const TypographyPage = () => (
  <PageShell
    title="Typography"
    description="Aegis uses Inter for UI text and IBM Plex Mono for data and code. The type scale is designed for data-rich healthcare interfaces where readability and scanability are critical."
  >
...
const RadiusPage = () => (
  <PageShell
    title="Radius"
    description="Border radius tokens control the roundness of component corners. Aegis defaults to softer radii for a calm, approachable feel appropriate for healthcare contexts."
  >
...
const ShadowsPage = () => (
  <PageShell
    title="Shadows"
    description="Elevation shadows create visual hierarchy and depth. Aegis uses soft, cool-toned shadows that feel grounded and professional. Focus rings use the brand primary color for clear keyboard navigation indicators."
  >
...
const MotionPage = () => (
  <PageShell
    title="Motion"
    description="Motion tokens define timing and easing for all transitions and animations. Aegis uses restrained, purposeful motion — fast enough to feel responsive, calm enough to avoid distraction in clinical workflows."
  >
...
const FocusPage = () => (
  <PageShell
    title="Focus"
    description="Focus indicators ensure keyboard and assistive technology users can navigate the interface. Aegis uses visible, high-contrast focus rings that meet WCAG 2.1 requirements."
  >
