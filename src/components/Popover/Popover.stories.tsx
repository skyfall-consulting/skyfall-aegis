  ...
  args: {
    ...
    content: (
      <div>
        ...
        <p style={{ margin: '8px 0 0', color: 'var(--aegis-color-text-secondary)' }}>
...
export const MedicationDetails: Story = {
  ...
  args: {
    trigger: (
      <span style={{ textDecoration: 'underline', cursor: 'pointer', color: 'var(--aegis-color-brand-primary-500)', fontFamily: 'var(--aegis-font-family-sans)' }}>
        Lisinopril 10mg
      </span>
    ),
    content: (
      <div style={{ maxWidth: 260, fontFamily: 'var(--aegis-font-family-sans)' }}>
        <strong>Lisinopril 10mg</strong>
        <p style={{ margin: '4px 0', fontSize: 13, color: 'var(--aegis-color-text-secondary)' }}>
