...
const activeLinkStyle: React.CSSProperties = {
  ...
  backgroundColor: 'var(--aegis-color-brand-primary-50)',
};
...
const AvatarSmall = () => (
  <div style={{
    ...
    backgroundColor: 'var(--aegis-color-brand-primary-100)',
...
const BellIcon = () => (
  <button type="button" style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 4, display: 'flex', color: 'var(--aegis-color-text-muted)' }}>
...
export const Default: Story = {
  args: {
    logo: <span style={{ fontSize: 18, fontWeight: 700 }}>Aegis Health</span>,
    children: (
      <>
...
export const WithSearch: Story = {
  args: {
    logo: <span style={{ fontSize: 18, fontWeight: 700 }}>Aegis</span>,
    children: (
      <>
