...
export const Default: Story = {
  render: (args) => (
    <Table {...args}>
      ...
      <TableBody>
        <TableRow>
          <TableCell style={{ fontFamily: 'var(--aegis-font-family-mono)' }}>001234</TableCell>
          <TableCell>Jane Cooper</TableCell>
          <TableCell>Cardiology</TableCell>
          <TableCell>Active</TableCell>
        </TableRow>
        <TableRow>
          <TableCell style={{ fontFamily: 'var(--aegis-font-family-mono)' }}>001235</TableCell>
          <TableCell>Robert Fox</TableCell>
          <TableCell>Neurology</TableCell>
          <TableCell>Pending</TableCell>
        </TableRow>
        <TableRow>
          <TableCell style={{ fontFamily: 'var(--aegis-font-family-mono)' }}>001236</TableCell>
