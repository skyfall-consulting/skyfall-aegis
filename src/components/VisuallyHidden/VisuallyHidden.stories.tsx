...
export const Default: Story = {
  render: () => (
    <div style={{ fontFamily: 'var(--aegis-font-family-sans)', fontSize: 14, color: 'var(--aegis-color-text-secondary)' }}>
      ...
      <p style={{ marginTop: 8, fontStyle: 'italic', color: 'var(--aegis-color-text-muted)' }}>
...
export const SkipLink: Story = {
  ...
  render: () => (
    <div style={{ fontFamily: 'var(--aegis-font-family-sans)', fontSize: 14 }}>
      ...
      <p style={{ color: 'var(--aegis-color-text-muted)' }}>Tab into this story to see the skip link appear</p>
    </div>
  ),
};
