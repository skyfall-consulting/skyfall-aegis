...
export const WithCustomPlaceholder: Story = {
  ...
  render: () => {
    ...
    return (
      <div>
        <button onClick={() => setOpen(true)} style={{ padding: '8px 16px', fontFamily: 'var(--aegis-font-family-sans)', fontSize: 14, border: '1px solid var(--aegis-color-border-default)', borderRadius: 6, background: 'var(--aegis-color-surface-default)', cursor: 'pointer' }}>
          Open
        </button>
        <CommandPalette
          open={open}
