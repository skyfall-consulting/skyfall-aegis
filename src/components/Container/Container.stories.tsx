...
const DemoContent = ({ label }: { label: string }) => (
  <div style={{ padding: 24, background: 'var(--aegis-color-surface-subtle)', borderRadius: 8, border: '1px dashed var(--aegis-color-border-default)', textAlign: 'center', fontFamily: 'var(--aegis-font-family-sans)', color: 'var(--aegis-color-text-secondary)' }}>
    {label}
  </div>
);
