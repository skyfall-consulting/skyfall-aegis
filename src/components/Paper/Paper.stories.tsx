...
export const Surfaces: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', padding: 24, background: 'var(--aegis-color-surface-canvas)', borderRadius: 12 }}>
...
export const CompositionHint: Story = {
  ...
  render: () => (
    <Paper elevation={2} radius="lg" padding="lg" style={{ maxWidth: 360 }}>
      <h3 style={{ margin: '0 0 8px', fontSize: 16, fontWeight: 600, color: 'var(--aegis-color-text-primary)' }}>
        Patient Summary
      </h3>
      <p style={{ margin: 0, fontSize: 14, color: 'var(--aegis-color-text-secondary)', lineHeight: '22px' }}>
