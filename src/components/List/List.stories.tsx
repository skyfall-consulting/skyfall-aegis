  ...
  render: () => (
    <List divided>
      <ListItem
        ...
        suffix={<StatusDot color="var(--aegis-color-success-500)" />}
        onClick={() => {}}
      >
        Jane Cooper
      </ListItem>
      <ListItem
        ...
        suffix={<StatusDot color="var(--aegis-color-warning-500)" />}
        onClick={() => {}}
      >
        Robert Wilson
      </ListItem>
      ...
      <ListItem
        ...
        suffix={<StatusDot color="var(--aegis-color-error-500)" />}
        onClick={() => {}}
        disabled
      >
        David Park
...
export const NotificationList: Story = {
  render: () => {
    const BellIcon = () => (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="currentColor" style={{ color: 'var(--aegis-color-text-muted)' }}>
