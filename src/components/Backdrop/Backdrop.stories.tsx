      ...
      <>
        ...
        <Backdrop open={open} onClick={() => setOpen(false)}>
          <div style={{
            ...
            padding: 32,
            maxWidth: 360,
            boxShadow: 'var(--aegis-shadow-xl)',
            textAlign: 'center',
          }}>
            <p style={{ margin: '0 0 16px', fontSize: 14, color: 'var(--aegis-color-text-primary)' }}>
        ...
        {active && (
          <Backdrop open variant={active as any} onClick={() => setActive(null)}>
            <div style={{
              ...
              <p style={{ margin: '0 0 12px', fontSize: 14, color: 'var(--aegis-color-text-primary)' }}>
                variant="{active}"
              </p>
