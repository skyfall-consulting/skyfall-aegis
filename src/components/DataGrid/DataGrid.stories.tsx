...
const patientColumns: DataGridColumn<Patient>[] = [
  {
    ...
    width: 90,
    render: (v) => (
      <span style={{ fontFamily: 'var(--aegis-font-family-mono)' }}>{v as string}</span>
    ),
  },
...
export const Selectable: Story = {
  ...
  render: () => {
    ...
    return (
      <div>
        <p style={{ fontFamily: 'var(--aegis-font-family-sans)', fontSize: 13, color: 'var(--aegis-color-text-muted)', marginBottom: 8 }}>
...
export const WithRowClick: Story = {
  ...
  render: () => {
    ...
    return (
      <div>
        {clicked && (
          <p style={{ fontFamily: 'var(--aegis-font-family-sans)', fontSize: 13, color: 'var(--aegis-color-text-secondary)', marginBottom: 8 }}>
            Clicked: {clicked}
          </p>
        )}
        <DataGrid
...
export const KitchenSink: Story = {
  ...
  render: () => {
        ...
        render: (_v, row) => (
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: 'var(--aegis-color-text-muted)' }}>MRN: {row.mrn}</div>
            </div>
          </div>
        ),
      },
    ...
    return (
      <div>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12, fontFamily: 'var(--aegis-font-family-sans)' }}>
          <h3 style={{ margin: 0, fontSize: 18, fontWeight: 600, color: 'var(--aegis-color-text-primary)' }}>
            Patient Directory
          </h3>
          <span style={{ fontSize: 13, color: 'var(--aegis-color-text-muted)' }}>
