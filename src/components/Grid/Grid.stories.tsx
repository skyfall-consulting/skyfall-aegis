...
const Cell = ({ children }: { children: React.ReactNode }) => (
  <div style={{ padding: 16, background: 'var(--aegis-color-surface-subtle)', borderRadius: 8, border: '1px solid var(--aegis-color-border-default)', textAlign: 'center', fontFamily: 'var(--aegis-font-family-sans)', fontSize: 14, color: 'var(--aegis-color-text-secondary)' }}>
    {children}
  </div>
);
